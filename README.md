...
| **Contracts** — 55 Pydantic v2 models | The single source of truth. Go structs and TypeScript types are generated from them, and drift fails the build. |
...
| **1465 tests** | Structural, security and type-level guards among them, each guard verified against a planted violation in both directions. |
