...
| `10-block-ordering.json` | the clock rule rewritten as contiguous blocks | record 03's confirmation run. Same 62 templates and Jaccard 1.00, converging at n=500 instead of n=1000 |
